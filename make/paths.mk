...
PACKAGE_DISPLAY_NAME ?= Carta
PACKAGE_BUNDLE_ID ?= com.cosm.carta
PACKAGE_PROFILE ?= standard
PACKAGE_RUNTIME_NAMESPACE ?= Carta
PACKAGE_LOG_NAMESPACE ?= Carta
PACKAGE_BUILD_LABEL ?= Carta-$(RELEASE_VERSION)
...
MAIN_EDIT_APP_NAME := Carta Main Edit.app
MAIN_EDIT_DISPLAY_NAME := Carta Main Edit
MAIN_EDIT_BUNDLE_ID := com.cosm.carta.main-edit
MAIN_EDIT_RUNTIME_NAMESPACE := MapForge-Main-Edit
MAIN_EDIT_LOG_NAMESPACE := MapForge-Main-Edit
MAIN_EDIT_PROFILE := main-edit
MAIN_EDIT_BUILD_LABEL = Carta-main-edit-$(RELEASE_VERSION)
...
MAIN_EDIT_SELF_TEST_DIR := $(TARGET_BUILD_ROOT)/package-main-edit-self-test
