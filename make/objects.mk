...
APP_CFLAGS += -I$(VK_RUNTIME_INCLUDE) -DMAPFORGE_HAVE_VK_RUNTIME=1
HOST_CFLAGS += -I$(VK_RUNTIME_INCLUDE) -DMAPFORGE_HAVE_VK_RUNTIME=1
LINK_OBJS += $(VK_RUNTIME_OBJS)
endif
