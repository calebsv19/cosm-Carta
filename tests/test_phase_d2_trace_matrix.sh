...
run_case "seattle" "${MAPFORGE_PHASE_D2_MATRIX_SEATTLE_MAX_L0_MS:-3500}" "${MAPFORGE_PHASE_D2_MATRIX_SEATTLE_MIN_COV:-0.55}" "${MAPFORGE_PHASE_D2_MATRIX_SEATTLE_MAX_CONSEC_BELOW:-6}"
